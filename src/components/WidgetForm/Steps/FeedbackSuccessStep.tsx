...
interface FeedbackContentSuccessStepProps {
  onFeedbackRestartRequested: () => void
}

export function FeedbackSuccessStep({onFeedbackRestartRequested}: FeedbackContentSuccessStepProps) {
  return (
    <>
      <header>
        <CloseButton />
